...
inc_spd();
    ...
    if(moveobs <= 2.5 && manXL1<=posx-.45f && moveobs >= 2)///detects collision for car1
    {
        collide=1;
    ...
    if(moveobs2 <= 4.8 && manXL1>=posx-.15f && moveobs2 >= 4.0)///detects collision for car1  manXL1>=posx-.45f
    ...
    if(moveobs4 <= -2.2 && manXL1<=posx-.45f && moveobs >= -2.9)///detects collision for && manXL1>=posx-.15f && moveobs2 >= 4.0
